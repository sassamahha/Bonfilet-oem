          ...
          {[
            {
              ...
              description: 'Live quote including shipping, tax, duties and arrival window.'
            },
            {
              title: 'Manufactured in 3 days',
              description: 'Automated prepress → production → QC → global shipping updates.'
            },
            {
              title: 'Designed for scaling',
              description: 'Locale-aware checkout, Stripe payments, operations dashboard built-in.'
            }
          ].map((feature) => (
            <div key={feature.title} className="rounded-lg border border-slate-200 bg-slate-50 p-6 shadow-sm">
